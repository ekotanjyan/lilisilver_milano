{capture name=path}
    <span class="navigation-pipe">{$navigationPipe}</span>{l s='Add new testimonial' mod='labtestimonials'}
{/capture}
<div id="testimonials_block_center" class="block" xmlns="http://www.w3.org/1999/html">
  <h4 class="title_block">{l s='Add new one testimonial' mod='labtestimonials'}</h4>
  {if $errors}
   ...
   <div class="col-xs-6 col-md-12 form-submit">
    <form name="fr_testimonial" id="fr_testimonial" action="" method="post" enctype="multipart/form-data">
        <div class="form-group">
          <label  class="col-sm-4 control-label">{l s='Your Name' mod='labtestimonials'}:</label>
            <div class="col-sm-10">
         ...
         <div class="form-group">
              <label  class="col-sm-4 control-label">{l s='Your Email' mod='labtestimonials'}:</label>
              <div class="col-sm-10">
                 <p class="form-group">
      ...
      <div class="form-group">
         <label class="col-sm-4 control-label">{l s='Company' mod='labtestimonials'}:</label>
            <div class="col-sm-10">
            <input id="company" name="company" type="text" value="{if isset($company)}{$company|escape:'html':'UTF-8'}{/if}" size="40" class="form-control"/>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-4 control-label">{l s='Address' mod='labtestimonials'}:</label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            <label class="col-sm-4 control-label" >{l s='Media Link' mod='labtestimonials'}:</label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            <label class="col-sm-4 control-label">{l s='Multimedia' mod='labtestimonials'}:</label>
            <div class="col-sm-10">
                <input id="media" name="media" type="file" value="" size="40" class="form-control"/>
                <sup class="require">*</sup>
            </div></div>
        <div class="form-group">
          <label class="col-sm-4 control-label">{l s='Content' mod='labtestimonials'}:</label>
            <div class="col-sm-10">
        ...
        {if $captcha == 1}
            <div class="form-group">
            <label class="col-sm-3 control-label">{l s='Captcha' mod='labtestimonials'}:</label>
            <div class="col-sm-5">
                <input name="captcha" type="text" value="" size="20" class="form-control"/>
                <sup class="require">*</sup>
            </div>
            <div class="col-sm-4">
                <img src="{$captcha_code}" alt="{l s='captcha' mod='labtestimonials'}"/>
            </div></div>
        {/if}
        <div class="form-group">
            <div class="col-sm-5">
                <button id="submitNewTestimonial"  class="button btn btn-default button-medium" name="submitNewTestimonial" type="submit" value="{l s='Send Your Testimonial' mod='labtestimonials'}"><span> {l s='send' mod='labtestimonials'} </span></button>
            </div>
            <label class="col-sm-4 control-label require"> {l s='* required field' mod='labtestimonials'} </label>
        </div>
    </form>
  </div>
</div>
