				...
				<div class="box-info-product">
					...
					<div class="box-cart-bottom row">
						...
						<div class="col-lg-8 col-md-6 col-sm-7 col-xs-12">
							<div id="labCart" {if (!$allow_oosp && $product->quantity <= 0) || !$product->available_for_order || (isset($restricted_country_mode) && $restricted_country_mode) || $PS_CATALOG_MODE} class="unvisible"{/if}>
...
<div class="more-info">
	<div class="more-info-ii">
		<ul id="more_info_tabs" class="idTabs idTabsShort">
			{if $product->description}<li class="first"><a id="more_info_tab_more_info" href="#idTab1">{l s='More info'}</a><i class="pe-7s-close"></i></li>{/if}
			{if $features}<li><a id="more_info_tab_data_sheet" href="#idTab2">{l s='Data sheet'}</a><i class="pe-7s-close"></i></li>{/if}
			{if $attachments}<li><a id="more_info_tab_attachments" href="#idTab9">{l s='Download'}</a><i class="pe-7s-close"></i></li>{/if}
			
			{if isset($product) && $product->customizable}<li><a href="#idTab10">{l s='Product customization'}</a><i class="pe-7s-close"></i></li>{/if}
			{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}<li><a href="#idTab11">{l s='Volume discounts'}</a><i class="pe-7s-close"></i></li>{/if}
			{if isset($packItems) && $packItems|@count > 0}<li><a href="#idTab12">{l s='Pack content'}</a><i class="pe-7s-close"></i></li>{/if}
	...
	<div class="tab-content">
		...
		{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
			...
			{if isset($packItems) && $packItems|@count > 0}
				<section id="idTab12" class="page-product-box">
									...
									<div  class="item">
											...
											<div class="left-block">
												<div class="product-image-container">
													<a href="{$accessoryLink|escape:'html':'UTF-8'}" title="{$accessory.legend|escape:'html':'UTF-8'}" class="product_image">
														<img class="img-responsive" src="{$link->getImageLink($accessory.link_rewrite, $accessory.id_image, 'large_default')|escape:'html':'UTF-8'}" alt="{$accessory.legend|escape:'html':'UTF-8'}" width="{$homeSize.width}" height="{$homeSize.height}"/>
													</a>
												</div>
												<div class="actions">
													...
													{/if}
														...
														<li class="lab-quick-view">
															<a class="quick-view" 
																	href="{$accessory.link|escape:'html':'UTF-8'}" 
														...
														<li class="lab-Wishlist">
															<a onclick="WishlistCart('wishlist_block_list', 'add', '{$accessory.id_product|intval}', $('#idCombination').val(), 1,'tabproduct'); return false;" class="add-wishlist wishlist_button" href="#"
													...
													<div itemprop="offers" itemscope itemtype="http://schema.org/Offer" class="content_price lab-price">
														{if isset($accessory.show_price) && $accessory.show_price && !isset($restricted_country_mode)}
															...
															{if isset($accessory.specific_prices) && $accessory.specific_prices && isset($accessory.specific_prices.reduction) && $accessory.specific_prices.reduction > 0}
																...
																{hook h="displayProductPriceBlock" id_product=$accessory.id_product type="old_price"}
															{/if}
