...
<ul class="display pull-right hidden-xs">
    ...
    <li id="grid"><a rel="nofollow" href="#" title="{l s='Grid'}"><i class="icon-th"></i><!-- {l s='Grid'} --></a></li>
    <li id="list"><a rel="nofollow" href="#" title="{l s='List'}"><i class="icon-list"></i><!-- {l s='List'} --></a></li>
</ul>
...
<form id="productsSortForm{if isset($paginationId)}_{$paginationId}{/if}" action="{$request|escape:'html':'UTF-8'}" class="productsSortForm pull-left">
