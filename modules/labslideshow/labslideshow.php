...
class labslideshow extends Module
{
	...
	public function install()
	{
		...
		foreach (Language::getLanguages() as $language)
            $tab->name[$language['id_lang']] = $this->l('Configure banner Slider');
		...
		)
		{
			...
			$res &= Configuration::updateValue('LAB_E_N_P', '0');
			$res &= Configuration::updateValue('LAB_E_CONTROL', '1');
			$res &= Configuration::updateValue('LAB_TITLE', '1');
			/* Creates tables */
	...
	protected function createTables()
	{
        ...
        $sql1 = "INSERT INTO `"._DB_PREFIX_."labslideshow_slides_lang` (`id_labslideshow_slides`, `id_lang`, `title`, `description`, `legend`, `url`, `image`) VALUES
			('17','1','fashion','<h5>&amp;style</h5>','new','#','d06f892ebd1d09791380111a345ded2ebc3a01a8_banner_6_1.jpg'),
			('17','2','fashion','<h5>&amp;style</h5>','new','#','befaad901982b6ae481462b87d80b64e39e24f26_banner_6_1.jpg'),
			('18','1','real man','','Lookbook','#','af13033c542ab571caec50b6cb6de4f29b9d8f2a_banner_6_2.jpg'),
			('18','2','real man','','Lookbook','#','eac982d86d3e2ab0bba9e65a002c5803a41a4ba5_banner_6_2.jpg')
