...
class AdminLabManagerBlocksController extends ModuleAdminController {
    protected $id_banner;
    public function __construct() {
        $this->table = 'lab_managerblock';
        $this->className = 'Managerblock';
        $this->identifier = 'id_labmanagerblock';
        $this->lang = true;
		$this->bootstrap = true;
        $this->deleted = false;
