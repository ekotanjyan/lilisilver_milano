...
class labtestimonials extends Module
{
   ...
   public function __construct()
    ...
    {
        if (parent::install() &&  $this->registerHook('blockPosition3')) {
            $res = $this->installDb();
    ...
    public function installDb(){
      ...
      $sql =  "INSERT INTO `"._DB_PREFIX_."labtestimonial`(`id_labtestimonial`,`name_post`,`email`,`company`,`address`,`media`,`media_type`,`content`,`date_add`,`active`,`position`) VALUES
            ('1','labthemes','demo@demo.com','CEO & Founder Leebros','labtheme','908-11111.jpg','jpg','Vestibulum quis porttitor dui! Quisque viverra nunc mi, a pulvinar purus condimentum a. Aliquam condimentum mattis neque sed pretium','2014-10-29 00:00:00','1','0')
