...
class labtestimonialsViewsModuleFrontController extends ModuleFrontController
{
    public $errors = array();
    public $success;
    public $identifier;
    public function __construct()
    {
        ...
        $this->identifier = 'id_labtestimonial';
        smartyRegisterFunction($this->context->smarty, 'function', 'testimonialpaginationlink', array('labtestimonialsViewsModuleFrontController', 'getTestimonialPaginationLink'));
    }
    ...
    public function listAllTestimoninals()
    {
      ...
      //  var_dump($id);die;
        if ($id == 0) {
            $alltestimoninals = LabTestimonial::getAllTestimonials();
            $testimoninals = LabTestimonial::getAllTestimonials($p, $n);
         //   echo "<pre>".print_r($alltestimoninals,1);die;
            ...
            $testimoninals = LabTestimonial::getAllTestimonials(1, false, $id, false); //view all and curent testimonial

            $alltestimoninals = LabTestimonial::getAllTestimonials(1, false, false, $id); // view all other testimonial
            $page_other_testimonials = LabTestimonial::getAllTestimonials($p, $n, false, $id); // item on page
    ...
    public function formTestimoninals()
    {
        ...
        $captcha_code = _MODULE_DIR_ . 'labtestimonials/captcha.php';
    ...
    {
        $this->validateRules('labtestimonial');
        if (Tools::isSubmit('submitNewTestimonial')) {
            ...
            $captcha = $_SESSION['labtestimonials_captcha'];
