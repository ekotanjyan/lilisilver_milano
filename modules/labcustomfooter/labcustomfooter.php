...
public function installDb(){
		...
		$sql =  "INSERT INTO `"._DB_PREFIX_."lab_staticfooter` (`id_staticblock`, `identify`, `hook_position`, `name_module`, `hook_module`, `order`, `insert_module`, `active`, `is_default`, `showhook`) VALUES
			('3','milano-fashion.','blockFooter1','Chose Module','displayFooter','0','0','0','1','1'),
			('4','blockmyaccountfooter','blockFooter1','blocksocial','displayFooter','0','1','0','1','1'),
			('5','blocknewsletter','blockFooter1','blocknewsletter','displayFooter','0','1','0','1','1'),
			('6','blockcontactinfos','blockFooter2','blockcontactinfos','displayFooter','0','1','0','1','1'),
			('7','blockcategories','blockFooter2','blockcategories','displayFooter','0','1','0','1','1'),
			('9','blockcms','blockFooter2','blockcms','displayFooter','0','1','0','1','1'),
			('10','blockmyaccountfooter','blockFooter2','blockmyaccountfooter','displayFooter','0','1','0','0','1'),
			('11','custom-link','blockFooter3','Chose Module','displayFooter','0','0','0','0','1'),
			('12','copyright','blockFooter3','Chose Module','displayFooter','0','0','0','0','1')
			
			";
        $sql1 = "INSERT INTO `"._DB_PREFIX_."lab_staticfooter_lang` (`id_staticblock`, `id_lang`, `title`, `description`) VALUES
			('3','1','milano fashion.','<div class=\"col-lg-3 col-md-3 col-sm-3 col-xs-12\">\r\n<h3 class=\"nameSite\">milano fashion.</h3>\r\n</div>'),
			('3','2','blocknewsletter','<div class=\"col-lg-3 col-md-3 col-sm-3 col-xs-12\">\r\n<h3 class=\"nameSite\">milano fashion.</h3>\r\n</div>'),
			('4','1','blockmyaccountfooter',NULL),
			('4','2','blocksocial',NULL),
			('5','1','blocknewsletter',NULL),
			('5','2','blocknewsletter',NULL),
			('6','1','blockcontactinfos',NULL),
			('6','2','blockcategories',NULL),
			('7','1','blockcategories',NULL),
			('7','2','blockcategories',NULL),
			('9','1','blockcms',NULL),
			('9','2','blockcms',NULL),
			('10','1','blockmyaccountfooter',NULL),
			('10','2','blockmyaccountfooter',NULL),
			('11','1','custom link','<ul class=\"custom-link\">\r\n<li><a href=\"#\">About Us</a></li>\r\n<li><a href=\"#\">Contact Us</a></li>\r\n<li><a href=\"#\">Customer Service</a></li>\r\n<li><a href=\"#\">Privacy Policy</a></li>\r\n<li><a href=\"#\">Accessibility</a></li>\r\n<li><a href=\"#\">Store Directory</a></li>\r\n</ul>'),
			('11','2','custom link','<ul class=\"custom-link\">\r\n<li><a href=\"#\">About Us</a></li>\r\n<li><a href=\"#\">Contact Us</a></li>\r\n<li><a href=\"#\">Customer Service</a></li>\r\n<li><a href=\"#\">Privacy Policy</a></li>\r\n<li><a href=\"#\">Accessibility</a></li>\r\n<li><a href=\"#\">Store Directory</a></li>\r\n</ul>'),
			('12','1','copyright','<div class=\"copyright\">Copyright © 2015 <a href=\"http://laberthemes.com/\">Laberthemes. </a>All Rights Reserved</div>'),
			('12','2','copyright','<div class=\"copyright\">Copyright © 2015 <a href=\"http://laberthemes.com/\">Laberthemes. </a>All Rights Reserved</div>')
