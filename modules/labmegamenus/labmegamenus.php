...
//        $html[] = '</a>';
			...
			switch (substr($item, 0, strlen($value[1])))
			{
				...
				case 'PRD':
					...
					if (!is_null($product->id))
						$this->_menuLink .= '<div id ="lab_menu_product" class="lab_menu"><div class="parentMenu" ><a href="'.Tools::HtmlEntitiesUTF8($product->getLink()).'"><span>'.$product->name.'</span></a></div></div>'.PHP_EOL;
						$this->_menuLinkMobile .= '<li id ="lab_menu_product" class="lab_menu"><div class="parentMenu" ><a href="'.Tools::HtmlEntitiesUTF8($product->getLink()).'"><span>'.$product->name.'</span></a></div></li>'.PHP_EOL;
					break;
				case 'NEWPRODUCT':
                    ...
                    $this->_menuLink .= '<div id ="lab_newproducts" class="lab_menu labmenuproducts"><div class="parentMenu" ><a href="'.__PS_BASE_URI__."new-products".'"><span>' . $this->l('New Product') . ' </span><span class="icon-new">' . $this->l('New') . '</span></a>';
				...
				case 'SALEPRODUCT':
                   ...
                   // echo "<pre>".print_r($SaleProducts,1);die;
                    $this->_menuLink .= '<div id ="lab_saleProducts" class="lab_menu labmenuproducts"><div class="parentMenu" ><a href="'.__PS_BASE_URI__."prices-drop".'"><span>' . $this->l(' Sale') . '</span><span class="icon-hot">' . $this->l('Hot') . '</span></a>';
                    $this->_menuLink .= '</div>'.PHP_EOL;
					$this->_menuLink .= '<div class ="popup" style ="display:none">';
					$this->_menuLink .= '<div class ="block1">';
                   // echo "<pre>".print_r($SaleProducts,1);die;
				...
				case 'CMS':
					...
					if (count($cms))
					$this->_menuLink .= '<div id ="lab_menu_cms" class="lab_menu"><div class="parentMenu" ><a href="'.Tools::HtmlEntitiesUTF8($cms[0]['link']).'"><span>'.$cms[0]['meta_title'].'</span></a></div></div>'.PHP_EOL;
				...
				case 'CMS_CAT':
					...
					$this->_menuLink .= '<div id ="lab_menu_cms" class="lab_menu"><div class="parentMenu" ><a href="'.Tools::HtmlEntitiesUTF8($category->getLink()).'"><span>'.$category->name.'</span></a>';
					$this->_menuLink .= '</div>'.PHP_EOL;
				...
				case 'ALLMAN':
					...
					$link = new Link;
					$this->_menuLink .= '<div id ="lab_menu_allsub" class="lab_menu"><div class="parentMenu" ><a href="'.$link->getPageLink('manufacturer').'" ><span>'.$this->l('Manufacturers').'</span></a></div>'.PHP_EOL;
					...
					$this->_menuLinkMobile .= '<li id ="lab_menu_allsub"><a href="'.$link->getPageLink('manufacturer').'" ><span>'.$this->l('Manufacturers').'</span></a>'.PHP_EOL;
				...
				case 'MAN':
					...
					if (!is_null($manufacturer->id))
					{
						...
						$link = new Link;
						$this->_menuLink .= '<div id ="lab_menu_man" class="lab_menu"><div class="parentMenu" ><a href="'.Tools::HtmlEntitiesUTF8($link->getManufacturerLink((int)$id, $manufacturer->link_rewrite)).'"><span>'.$manufacturer->name.'</span></a></div></div>'.PHP_EOL;
						$this->_menuLinkMobile .= '<li id ="lab_menu_man" class="lab_menu"><a href="'.Tools::HtmlEntitiesUTF8($link->getManufacturerLink((int)$id, $manufacturer->link_rewrite)).'"><span>'.$manufacturer->name.'</span></a></li>'.PHP_EOL;
				...
				case 'ALLSUP':
					$link = new Link;
					$this->_menuLink .= '<div id ="lab_menu_allsub" class="lab_menu"><div class="parentMenu" ><a href="'.$link->getPageLink('supplier').'" ><span>'.$this->l('All suppliers').'</span></a></div>'.PHP_EOL;
					...
					$this->_menuLinkMobile .= '<li id ="lab_menu_allsub"><a href="'.$link->getPageLink('supplier').'" ><span>'.$this->l('All suppliers').'</span></a>'.PHP_EOL;
					$this->_menuLinkMobile .= '<ul class ="popup">';
					foreach ($suppliers as $key => $supplier)
				...
				case 'SUP':
					...
					if (!is_null($supplier->id))
					{
						...
						$this->_menuLink .= '<div id ="lab_menu_sub" class="lab_menu"><div class="parentMenu" ><a href="'.Tools::HtmlEntitiesUTF8($link->getSupplierLink((int)$id, $supplier->link_rewrite)).'"><span>'.$supplier->name.'</span></a></div></div>'.PHP_EOL;
						$this->_menuLinkMobile .= '<li id ="lab_menu_sub" class="lab_menu"><a href="'.Tools::HtmlEntitiesUTF8($link->getSupplierLink((int)$id, $supplier->link_rewrite)).'"><span>'.$supplier->name.'</span></a></li>'.PHP_EOL;
				...
				case 'SHOP':
					...
					{
						$link = new Link;
						$this->_menuLink .= '<div id ="lab_menu_sub" class="lab_menu"><div class="parentMenu" ><a href="'.Tools::HtmlEntitiesUTF8($shop->getBaseURL()).'"><span>'.$supplier->name.'</span></a></div></div>'.PHP_EOL;
				...
				case 'LNK':
					...
					if (count($link))
					{
						...
						$this->_menuLink .= '<div id ="lab_menu_link" class="lab_menu"><div class="parentMenu" ><a href="' . __PS_BASE_URI__ . ''.($link[0]['link']).'"'.(($link[0]['new_window']) ? ' target="_blank"': '').'><span>'.$link[0]['label'].'</span></a></div></div>'.PHP_EOL;
    ...
    public function hooklabMegamenu() {
