...
class smartbloghomelatestnews extends Module {
	 ...
	 $this->DeleteCache();
            if (!parent::uninstall() || !Configuration::deleteByName('smartshowhomepost') || !Configuration::deleteByName('smartshowhomepostcolumn'))
                 return false;
            return true;
                }
	...
	{
		return $this->hookblockPosition4($params);
	}    
